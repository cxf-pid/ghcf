...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        self.ii = 10000 #用户总数为21716 取46%的用户量
        ...
        with open(train_file) as f_train:
            with open(test_file) as f_test:
                for l in f_train.readlines()[0:10000]: ###############
                    if len(l) == 0: break
                    l = l.strip('\n')
                ...
                for l in f_test.readlines()[0:10000]: ####################
                    if len(l) == 0: break
                    l = l.strip('\n')
                    try:
                        items = [int(i) for i in l.split(' ')]
        ...
        with open(cart_file) as f_cart:
            for l in f_cart.readlines()[:10000]:
                if len(l) == 0: break
                l = l.strip('\n')
                items = [int(i) for i in l.split(' ')]
